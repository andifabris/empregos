	...
	while true do
		...
		if servico then
			...
			if distance <= 25.0 then
				idle = 5
				DrawMarker(30,configfarmer.locsfarm[selecionadocolheita].x,configfarmer.locsfarm[selecionadocolheita].y,configfarmer.locsfarm[selecionadocolheita].z+0.20,0,0,0,0,180.0,130.0,2.0,2.0,1.0,255,0,0,50,1,0,0,1)
